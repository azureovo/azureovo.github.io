...
* **个人网站**：<a href="https://azureovo.github.io/" target="_blank">[戳这里，其实就是主页面]</a>
* **简历附件**：<a href="/files/260102简历.pdf" target="_blank">[2026年01月02日版本]</a>
...
<ul style="list-style-type: disc; padding-left: 20px;">
  <li style="margin-bottom: 35px;">
    ...
    <ul style="margin-top: 8px; line-height: 1.6; color: #333;">
      ...
      <li><strong>模型迭代与MVP验证</strong>：搭建标准化的模型评估与迭代 Pipeline，有效平衡了算力成本与模型性能。在 Kinova Gen3 平台上完成真机 MVP（最小可行性产品）验证，数据显示系统在复杂果园场景下的 Mask mAP50 达 0.661，核心业务目标（果簇）识别精度达 0.811，验证了自动化策略的商业落地可行性。</li>
    </ul>
  </li>
  ...
  <li style="margin-bottom: 35px;">
    ...
    <ul style="margin-top: 8px; line-height: 1.6; color: #333;">
      ...
      <li><strong>结果交付与成果</strong>：协调软硬件团队资源，在真实工业高并发场景下完成压力测试，验证了工业商业模式可行性，获中国高校计算机大赛网络技术挑战赛全国二等奖。</li>
    </ul>
  </li>
  ...
  <li style="margin-bottom: 35px;">
    ...
    <ul style="margin-top: 8px; line-height: 1.6; color: #333;">
      ...
      <li><strong>市场验证推广</strong>：策划“城市合伙人”与“高校设计大赛”推广策略，通过与博物馆、5A级景区建立合作试点，验证了“AI设计+实物交付”模式在千亿级文旅市场中的商业可行性。</li>
    </ul>
  </li>
  ...
  <li style="margin-bottom: 30px;">
    ...
    <ul style="margin-top: 8px; line-height: 1.6; color: #333;">
      ...
      <li><strong>通勤算法逻辑</strong>：针对多校区通勤痛点，设计校车查询模块。梳理复杂的路线逻辑（支持起点/终点互换、经停站点展示、教职工/学生班车分类），并引入实时公告变动机制。</li>
      <li><strong>功能闭环构建</strong>：搭建“失物招领”UGC平台，通过结构化标签（物品类型、地点）与搜索分发机制，建立“发布-审核-搜索-认领”的完整业务闭环，提升物品找回效率。</li>
    </ul>
  </li>
</ul>
...
* **荣誉奖项**：
  ...
  * 电子科技大学优秀毕业生
  * 电子科技大学校优秀学生奖学金（3年）<a href="/files/优生证书.pdf" target="_blank">[证书]</a>
  * 天空安全卫士企业奖学金
  * 数字天空优秀学员实习直通证明
* **产品技能**：
