...
工作经历
======
* **知名头部游戏公司（上海） / 用户体验及质量评估 / 2025年01月 – 2025年12月**
...
* **基于生成式先验的高保真3D逆向渲染框架 / 算法产品负责人 / CVPR2026在投**
  * **需求洞察**：针对传统3D重建方案在高光复杂光照场景下材质丢失、伪影严重的痛点，定义了新一代物理感知的逆渲染产品路径。
  * **解决方案设计**：设计了包含“混合可见性分解”、“生成式光照先验”等模块的完整技术架构，成功解决了材质与光照解耦的难题。
  * **效果验证**：在基准数据集上进行测试，核心指标PSNR等不仅达到SOTA，且在视觉真实感上显著优于对比基线（如TensoIR等）。
...
* **互联大师·工业智能网关及管理平台（从0到1全栈产品） / 产品设计师 & 项目管理 / 2023年08月 – 2023年12月**
  ...
  * **协议标准化设计**：设计并定义了ICCP通用工控协议标准，实现了N种私有协议的统一映射，将协议转换复杂度从 $O(N^2)$ 降低至 $O(N)$，极大提升了系统的扩展性。完成整个PRD文件的撰写。
